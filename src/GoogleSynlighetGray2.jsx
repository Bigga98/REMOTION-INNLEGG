...
export const GoogleSynlighetGray2 = () => {
  ...
  return (
    ...
    >
      ...
      >
        <defs>
          <radialGradient id="leafFadeGray2" cx="40%" cy="40%" r="60%">
        ...
        >
          ...
          <span
            style={{
              ...
              background: "linear-gradient(90deg, #6B9B9E, #5B8BC0, #6B9B9E, #7BAFB2, #6B9B9E)",
